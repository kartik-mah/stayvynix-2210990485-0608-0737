  ...
  return (
    <div className='w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto  relative'>
             ...
             {cardDetails.latitude && cardDetails.longitude && (
               <div className='w-[95%] md:w-[80%] mb-[30px]'>
                 <h2 className='text-[27px] font-semibold mb-[8px] px-[6px] text-[#222]'>Where you'll be</h2>
                 <p className='text-[18px] mb-[14px] px-[6px] text-[#5b5b5b]'>{`${cardDetails.landMark}, ${cardDetails.city}`}</p>
                 <LocationMap 
                   latitude={cardDetails.latitude}
                   longitude={cardDetails.longitude}
                        ...
                        <form className='max-w-[450px] w-[90%] h-[450px] overflow-auto bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-start flex-col gap-[10px]    border-[1px] border-[#dedddd]' onSubmit={(e)=>{
                            ...
                            <div className='w-[100%] h-[70%] mt-[10px] rounded-lg p-[10px]'>
                             ...
                             {checkIn && checkOut && total > 0 ? (
                                ...
                                <button className='px-[80px] py-[10px] bg-gray-400 text-[white] text-[18px] md:px-[100px] rounded-lg text-nowrap mt-[30px] cursor-not-allowed' disabled>Book Now</button>
                             )}
                             </div>
